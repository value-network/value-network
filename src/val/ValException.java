...
public abstract class ValException extends Exception {

    protected ValException() {
        super();
    }

    ValException(String message) {
        super(message);
    }

    ValException(String message, Throwable cause) {
        super(message, cause);
    }

    protected ValException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends ValException {
