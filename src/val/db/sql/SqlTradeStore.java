...
import static val.schema.Tables.TRADE;

public class SqlTradeStore implements TradeStore {
    private final val.db.sql.DbKey.LinkKeyFactory<Trade> tradeDbKeyFactory = new val.db.sql.DbKey.LinkKeyFactory<Trade>("ask_order_id", "bid_order_id") {
    ...
    @Override
    public val.db.sql.DbKey.LinkKeyFactory<Trade> getTradeDbKeyFactory() {
